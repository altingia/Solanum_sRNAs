...
# Usage
# Rscript --vanilla analyse_shortstack_results.R [path/to/shortStack_directory] [path/to/output_folder]
...
#######################################################################
# working directory
setwd("~/SURFdrive/trichome_team/06.results_from_xp/sRNA-Seq/20170117_srnadesc/")
outdir = "../../../11.analysis/sRNA/"
...
shortstack.dirs = sapply(X = accessions,FUN = function(x) {file.path(getwd(),"shortstack",x,"results.txt")})
